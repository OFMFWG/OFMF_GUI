...
$("#loginForm").submit(function(event) {
  ...
  sessionStorage.setItem("ofmf_addr", fields[0].value);
  sessionStorage.setItem("ofmf_port", fields[1].value);

/*  var auth = make_basic_auth(fields[2].value, fields[3].value);*/
  var auth = make_basic_auth(fields[0].value, fields[1].value);
  sessionStorage.setItem("ofmf_auth", auth);
...
function updateForm() {
  ...
  if (sessionStorage.getItem("ofmf_auth") != oldauth) {
  ...
  $("#editVerb").html("POST");
  $("#editUri").html("ofmf/signature");
  $("#objectType").html("ofmf");
